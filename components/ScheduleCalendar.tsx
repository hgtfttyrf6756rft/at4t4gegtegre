...
const PLATFORM_ICONS: Record<string, React.ReactNode> = {
    facebook: <img src="https://cI6wjaC8e4NWiqIn.public.blob.vercel-storage.com/2021_Facebook_icon.svg.webp" className="w-4 h-4 inline-block object-contain" alt="Facebook" />,
    instagram: <img src="https://cI6wjaC8e4NWiqIn.public.blob.vercel-storage.com/Instagram_logo_2016.svg.webp" className="w-4 h-4 inline-block object-contain" alt="Instagram" />,
    tiktok: <img src="https://cI6wjaC8e4NWiqIn.public.blob.vercel-storage.com/tiktok-6338432_1280.webp" className="w-4 h-4 inline-block object-contain" alt="TikTok" />,
    youtube: <img src="https://cI6wjaC8e4NWiqIn.public.blob.vercel-storage.com/YouTube_full-color_icon_%282017%29.svg.png" className="w-4 h-4 inline-block object-contain" alt="YouTube" />,
    linkedin: <img src="https://cI6wjaC8e4NWiqIn.public.blob.vercel-storage.com/LinkedIn_logo_initials.png" className="w-4 h-4 inline-block object-contain" alt="LinkedIn" />,
    x: <img src="https://cI6wjaC8e4NWiqIn.public.blob.vercel-storage.com/X-Logo-Round-Color.png" className="w-4 h-4 inline-block object-contain" alt="X" />,
