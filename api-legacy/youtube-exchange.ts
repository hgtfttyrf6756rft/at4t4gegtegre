...
export default {
    async fetch(request: Request): Promise<Response> {
        ...
        if (!clientId || !clientSecret) {
            return error('Missing YOUTUBE_CLIENT_ID/SECRET or GOOGLE_DRIVE_CLIENT_ID/SECRET environment variable.', 500);
        }
        ...
        const ref = db.doc(`users/${authResult.uid}/integrations/youtube`);
